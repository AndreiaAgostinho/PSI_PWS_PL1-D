...
create table flights(
    ...
    distancia double unsigned not null,
...
create table ticketsflights(
	...
	checkin	 enum('S','N') not null default "N",
...
insert into peoples values (default, "Admin", "M", "01-01-1990", "123456789", "Portugal", "910000000", "admin", "admin", "A"); 
